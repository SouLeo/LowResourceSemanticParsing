...
class EncoderRNN(nn.Module):
    ...
    def forward(self, input):
        # embedded = self.dropout(self.embedding(input.type(torch.LongTensor)))
    ...
    # def initHidden(self):
    #     return torch.zeros(2, 4, self.hidden_size)
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, src, trg, sos_seq, teacher_forcing_ratio=0.5):
        ...
        for t in range(1, max_len):
            ...
            output, hidden = self.decoder.forward(sos_seq, hidden, encoder_outputs)
